// Original page: https://www.intel.com/content/www/us/en/develop/documentation/get-started-with-cpp-fortran-compiler-openmp/top.html
...
int main() {
  ...
  fprintf(stderr, "There are %d non-host devices.\n", omp_get_num_devices());
